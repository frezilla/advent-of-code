...
print(
    f"Number of characters of code for string literals ({numbers_characters}) minus the number of characters in memory ({numbers_memory}) => {numbers_characters - numbers_memory}")
print(
    f"Total number of characters to represent the newly encoded string ({numbers_encoded}) minus the number of characters of code for string literals ({numbers_characters}) => {numbers_encoded - numbers_characters}")
