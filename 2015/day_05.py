...
niceStrings = part_one(open(inputFile, 'r'))
print(f"Part 1 : Number of nice strings: {niceStrings}")


niceStrings = part_two(open(inputFile, 'r'))
print(f"Part 2 : Number of nice strings: {niceStrings}")
